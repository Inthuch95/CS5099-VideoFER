...
from utils import load_au_sequence, plot_confusion_matrix, get_predictions_and_labels
...
base_dir = '../best model/' + data_type + '/AU/'
model_file =  base_dir + 'LSTM_best.h5'
# model_file = '../best model/LSTM_best/LSTM_best.h5'

if __name__ == '__main__':
    _, _, _, _, X_test, y_test = load_au_sequence(data_type=data_type)
